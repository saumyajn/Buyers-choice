	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar" style="font-size: 18px;">
			<ul class="nav navbar-nav">
				<li><a href="diffdest">Manage Destinations</a></li>
				<li><a href="diffpackage">Manage Packages</a></li>
				<li><a href="diff">Manage Hotels</a></li>
				<li><a href="diff">Manage Users</a></li>
