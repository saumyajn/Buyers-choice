...
<div class="row">
	...
	<table class="table table-responsive">
		...
		<tr ng-repeat="package in packages|filter:searchText">
			...
			<td><a href="Deletepackage?did={{package.packageid}}"><button type="button" class="btn btn-default">Delete</button></a></td>
			<td><a href="plzUpdatedpackage?did={{package.packageid}}"><button type="button" class="btn btn-default">Update</button></a></td>
		</tr>
	</table>
</div></div>
